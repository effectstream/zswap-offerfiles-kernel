...
// The generated ArchiveOfferBy* queries were removed together with their
// source in queries.sql — dead code superseded by the *WithHash prepared
// variants in queries.app.ts, which carry the chain-derived archived_at.
