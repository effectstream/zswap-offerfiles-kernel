...
// there is no migration chain. Edit 000-init.sql in place; do not add numbered
// migrations. local-migration.sql still runs last, for local-only additions
// that must not enter the shared schema.
